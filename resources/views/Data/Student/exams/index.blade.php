                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="quiz-card">
                                            ...
                                            <div class="quiz-body">
                                                ...
                                                @php
                                                $result = $quizze->results->where('quiz_id', $quizze->id)
                                                ...
                                                @if($result)
                                                @if($result->check)
                                                <a href="{{ route('show_exam_result', $quizze->id) }}"
                                                    onclick="alertAbuse()" class="quiz-btn">
                                                    {{ trans('Students_trans.show_result') }}
                                                </a>
                                                @else
                                                <button class="quiz-btn" disabled>
                                                    {{ trans('Students_trans.show_result_incomming') }}
                                                </button>
                                                @endif
                                                @else
