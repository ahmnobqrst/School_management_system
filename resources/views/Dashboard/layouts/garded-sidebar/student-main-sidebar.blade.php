                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul id="custom-page" class="collapse" data-parent="#sidebarnav">
                            <li> <a
                                    href="{{ route('student.appearnce') }}">{{ trans('sidebar_trans.Apperance_list') }}</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul id="timelab-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('student.timelab') }}">{{ trans('sidebar_trans.timetable') }}</a>
                            </li>
                        </ul>
                    </li>
                    <!-- <li>
                    ...
                    <li>
                        ...
                        <ul id="authentication" class="collapse" data-parent="#sidebarnav">
                            <li> <a
                                    href="{{ route('student_exams.index') }}">{{ trans('sidebar_trans.Exam_list') }}</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="questions" class="collapse" data-parent="#sidebarnav">
                            <li> <a
                                    href="{{ route('student_exams.index') }}">{{ trans('sidebar_trans.question') }}</a>
                            </li>
                        </ul>
                    </li>
                    <li>
