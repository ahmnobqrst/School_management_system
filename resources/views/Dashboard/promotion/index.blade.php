            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <h6 style="color: red;font-family: Cairo">{{__('Students_trans.Grade_old_name')}}</h6><br>
                    ...
                    <form method="post" action="{{ route('promotions.store') }}">
                        ...
                        <br><h6 style="color: red;font-family: Cairo">{{__('Students_trans.Grade_new_name')}}</h6><br>
