...
<style>
    ...
    .actions-dropdown .dropdown-menu {
        ...
        z-index: 9999; /* التأكد من ظهوره فوق كل شيء */
        background: #fff;
    }
    ...
    .actions-dropdown .dropdown-item:hover {
        ...
        transform: translateX(-5px); /* تحريك لليسار بما أن الاتجاه عربي */
    }
                                    ...
                                    <td>
                                        <div class="dropdown actions-dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" 
                                                ...
                                                <a class="dropdown-item" href="#">
                                                    <i class="fa fa-money-bill-wave text-success"></i> {{ trans('Students_trans.Add_new_reciept') }}
                                                </a>
                                                <a class="dropdown-item" href="#">
                                                    <i class="fas fa-money-bill-alt text-info"></i> {{ trans('Students_trans.Add_new_process') }}
                                                </a>
                                                <a class="dropdown-item" href="#">
                                                    <i class="fas fa-money-bill-alt text-info"></i> {{ trans('Students_trans.Add_payment') }}
                                                </a>
                                                <a class="dropdown-item text-danger" href="#">
                                                    <i class="fa fa-question-circle"></i> {{ trans('Students_trans.show_student_quiz') }}
                                                </a>
                                                <a class="dropdown-item text-danger" href="#">
                                                    <i class="fa fa-chart-bar"></i> {{ trans('Students_trans.show_student_result') }}
                                                </a>
