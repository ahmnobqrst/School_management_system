                ...
                <div class="card-body">
                    <div class="waiting-container">
                        ...
                        <h2 class="text-secondary font-weight-bold">
                            {{ trans('Students_trans.waiting_correction') ?? 'النتيجة قيد التصحيح حالياً' }}
                            <span class="loading-dots"></span>
                        </h2>
                        <p class="text-muted mt-2" style="font-size: 18px;">
                            {{ trans('Students_trans.waiting_note') ?? 'يرجى العودة لاحقاً لمراجعة إجاباتك ودرجاتك النهائية' }}
                        </p>
                    </div>
                </div>
            </div>
