            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('students.update',$students->id) }}" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="classroom_id" id="classroom_id">
                                    <option selected value="{{$students->classroom_id}}">{{$students->Classroom->name}}</option>
                                </select>
                            </div>
                            @error('classroom_id')
                            <span class="alert alert-danger alert-dismissible">{{ $message }}</span>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="section_id" id="section_id">
                                    <option selected value="{{$students->section_id}}">{{$students->Section->section_name}}</option>
                                </select>
                            </div>
                            @error('section_id')
                            <span class="alert alert-danger alert-dismissible">{{ $message }}</span>
                        ...
                        <div class="form-group">
                            <label for="Grade_id">{{trans('Students_trans.subjects')}} : <span class="text-danger">*</span></label>
                            <select class="custom-select mr-sm-2" name="subject_id[]" id="subject_id" multiple>
                                <!-- <option selected disabled value="{{$students->grade_id}}">{{$students->Grade->name}}</option> -->
                                @foreach($subjects as $subject)
                                <option value="{{ $subject->id }}"
                                    {{ $students->Subjects->contains($subject->id) ? 'selected' : '' }}>
                                    {{ $subject->name }}
                                </option>
                                @endforeach
                            </select>
        ...
        if (Grade_id) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        $('select[name="classroom_id"]').append('<option selected disabled >{{trans('
