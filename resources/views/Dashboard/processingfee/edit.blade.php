...
@toastr_css
@section('title')
{{trans('fee_trans.processingfee_edit')}}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
...
<div class="page-title">
    <div class="row">
        <div class="col-sm-12">
            <h4 class="mb-0">{{trans('fee_trans.processingfee_edit')}}</h4>
        </div>
        <div class="col-sm-12">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="{{route('reciept.index')}}"
                        class="default-color">{{trans('Students_trans.Home')}}</a></li>
                <li class="breadcrumb-item active">{{trans('fee_trans.processingfee_edit')}}</li>
            </ol>
        </div>
    </div>
</div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description_ar"
                                    rows="3">{{$ProcessingFee->getTranslation('description','ar')}}</textarea>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description_en"
                                    rows="3">{{$ProcessingFee->getTranslation('description','en')}}</textarea>
                            </div>
