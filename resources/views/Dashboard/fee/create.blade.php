...
<div class="page-title">
    <div class="row">
        <div class="col-sm-12">
            <h4 class="mb-0">{{trans('fee_trans.Add_fee_New')}}</h4>
        </div>
        <div class="col-sm-12">
                ...
                <form method="post"  action="{{ route('fees.store') }}" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{trans('fee_trans.desc_ar')}} : </label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{trans('fee_trans.desc_en')}} : </label>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="fee_type">{{trans('fee_trans.feee_type')}} : <span class="text-danger">*</span></label>
                                    
                                    <select class="custom-select mr-sm-2" name="fee_type">
                                    <option selected disabled>{{trans('Parent_trans.Choose')}}...</option>
                                      <option value="1">{{trans('fee_trans.fees_fee')}}</option>
                                      <option value="2">{{trans('fee_trans.fees_bus')}}</option>
                                    </select>
                                </div>
                                @error('fee_type')
                                <span class="alert alert-danger alert-dismissible">{{ $message }}</span>
