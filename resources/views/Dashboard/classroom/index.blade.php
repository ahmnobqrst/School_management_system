                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-outline-danger btn-sm"
                                        data-toggle="modal"
                                        data-target="#delete{{ $myclasses->id }}" title="حذف">
                                        <i class="fa fa-trash"></i>
                                    </button>
                                </td>
                            </tr>

                            <!-- this is model For Delete Classroom -->

                            <div class="modal fade" id="delete{{ $myclasses->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content border-0 shadow-lg">
                                        <div class="modal-header bg-danger text-white">
                                            <h5 class="modal-title text-white font-weight-bold" id="exampleModalLabel">
                                                <i class="fa fa-exclamation-triangle ml-2"></i> {{trans('grades_trans.Delete_grade_class')}}
                                            </h5>
                                            <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <form action="{{route('classrooms.destroy',$myclasses->id)}}" method="Post">
                                            @method('delete')
                                            @csrf
                                            <div class="modal-body text-center p-5">
                                                ...
                                                <p class="text-muted small">سيتم حذف هذا "{{$myclasses->name}}" وجميع البيانات المرتبطة بها.</p>
                                                <input type="hidden" name="id" value="{{$myclasses->id}}">
                                            </div>
...
<!-- this is model For Delete Multiple Classrooms -->
