                                                            ...
                                                            <table class="table center-aligned-table mb-0">
                                                                <thead>
                                                                    <tr class="text-dark">
                                                                        ...
                                                                        <th scope="col">
                                                                            {{ trans('section_trans.Teacher_name') }}</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @foreach ($grades->Sections as $list_Sections)
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                @if ($list_Sections->Teachers->count() > 0)
                                                                                    {{ $list_Sections->Teachers->pluck('name')->implode(', ') }}
                                                                                @else
                                                                                    لا يوجد معلم
                                                                                @endif
                                                                            </td>
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    <div class="modal-header">
                                                                                        <h5 class="modal-title">
                                                                                            {{ trans('section_trans.edit_Section_modal') }}
                                                                                        </h5>
                                                                                    </div>
                                                                                    <div class="modal-body">
                                                                                        <form
                                                                                            ...
                                                                                            <div class="col">
                                                                                                <label for="inputName"
                                                                                                    class="control-label">{{ trans('section_trans.GradeName') }}</label>
                                                                                            ...
                                                                                            <div class="col">
                                                                                                <label for="inputName"
                                                                                                    class="control-label">{{ trans('section_trans.ClassName') }}</label>
                                                                                            ...
                                                                                            <div class="modal-footer">
                                                                                                ...
                                                                                                <button type="submit"
                                                                                                    class="btn btn-danger">{{ trans('section_trans.Update') }}</button>
                                                                                            </div>
                                                                                        </form>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    <div class="modal-header">
                                                                                        <h5 style="font-family: 'Cairo', sans-serif;"
                                                                                            ...
                                                                                            {{ trans('section_trans.modal_delete_Section') }}
                                                                                        </h5>
                                                                                    </div>
                                                                                    <div class="modal-body">
                                                                                        <form
