    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="{{route('section.index')}}" class="default-color">{{trans('Students_trans.Home')}}</a></li>
                                                    ...
                                                    <table class="table center-aligned-table mb-0">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <!-- <a href="{{route('section.edit',$list_Sections)}}" class="btn btn-outline-info btn-sm" data-toggle="modal"
                                                                data-target="#edit{{ $list_Sections->id }}"><i class="fa fa-edit"></i></a> -->
                                                                    <button class="btn btn-outline-info btn-sm" title="Edit">
                                                                        <i class="fa fa-edit" data-id="" data-toggle="modal" data-target="#edit{{$list_Sections->id}}" id="editBtn"></i>
                                                                    </button>
                                                                    <button id="deleteBtn" class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#delete{{ $list_Sections->id }}">
                                                            ...
                                                            <div class="modal fade" id="edit{{ $list_Sections->id }}" role="dialog" aria-labelledby="Edit" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title">{{ trans('section_trans.edit_Section_modal') }} </h5>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <form action="{{route('section.update','test')}}" method="POST">
                                                                                ...
                                                                                <div class="col">
                                                                                    <label for="inputName" class="control-label">{{trans('section_trans.GradeName')}}</label>
                                                                                    <select name="Grade_id" class="custom-select" onclick="console.log($(this).val())">
                                                                                        <option value="{{ $grades->id }}">{{ $grades->name }}</option>
                                                                                        @foreach ($grade as $list_grade)
                                                                                        <option value="{{ $list_grade->id }}">{{ $list_grade->name }}</option>
                                                                                        @endforeach
                                                                                    </select>
                                                                                </div>
                                                                                <div class="col">
                                                                                    <label for="inputName" class="control-label">{{ trans('section_trans.ClassName') }}</label>
                                                                                    <select name="Class_id" class="custom-select">
                                                                                        <option value="{{ $list_Sections->Classes->id }}">{{ $list_Sections->Classes->name }}</option>
                                                                                    </select>
                                                                                </div>
                                                                                <div class="col">
                                                                                    <div class="form-check">
                                                                                        ...
                                                                                        @endif
                                                                                        <label class="form-check-label" for="exampleCheck1">{{ trans('section_trans.status') }}</label>
                                                                                    </div>
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    ...
                                                                                    <button type="submit" class="btn btn-danger">{{ trans('section_trans.Update') }}</button>
                                                                                </div>
                                                                            </form>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <!----------------------------------------------------------------------------------------End  modal for edit section ------------------------------------------------------------------------------------------------------------ -->


                                                            <!--------------------------------------------------------------------- the modal for delet section -------------------------------------------------------------------------------------------------------------------------------------->
                                                            <div class="modal fade" id="delete{{ $list_Sections->id }}" tabindex="-1" role="dialog" aria-labelledby="delete" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{ trans('section_trans.modal_delete_Section') }}</h5>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <form action="{{ route('section.destroy', 'test') }}" method="post">
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ trans('section_trans.Close') }}</button>
                                                                                    <button type="submit" class="btn btn-danger">{{ trans('section_trans.Delete') }}</button>
                                                                                </div>
                                                                            </form>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <!---------------------------------------------------------------------End  the modal for delet section ------------------------------------------------------------------------------------------------------------------------------------>
