...
Route::group(
    ...
    function () {
        ...
        Route::middleware(['auth:parent'])->group(function () {
            ...
            Route::post('stripe/payment/{studentId}', [ParentController::class, 'makeStripePayment'])->name('stripe.payment');

            Route::get('stripe/success/{studentId}', [ParentController::class, 'stripeSuccess'])->name('stripe.success');

            Route::post('stripe/webhook', [ParentController::class, 'stripeWebhook']);
